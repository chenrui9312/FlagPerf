...
from dataloaders.dataloader import build_datasets, build_train_dataloader, build_eval_dataloader
...
def build_dataloader():
    # 加载数据集
    config.data = config.data_dir
    datasets = build_datasets(config)
    # 初始化dataloader
    train = build_train_dataloader(datasets, config)
    eval = build_eval_dataloader(datasets, config)
    return train, eval
